...
import "../styles/components/FormularioRegistreSe.sass";

function FormularioRegistreSe() {
  const [mostrarSenha, setMostrarSenha] = useState(false);

  return (
    <div className="formulario-registreSe">
      <h1>Registre-se</h1>
...
export default FormularioRegistreSe;
