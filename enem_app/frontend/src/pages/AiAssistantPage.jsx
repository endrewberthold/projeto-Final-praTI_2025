  ...
  const sampleQuestions = [
    {
      ...
      correctAnswer:
        "A mitose produz duas células diploides idênticas, enquanto a meiose produz quatro células haploides geneticamente diferentes.",
      explanation: "Processo fundamental da reprodução celular",
    },
    {
      id: 2,
      question:
        "Como calcular a velocidade média em um movimento retilíneo uniforme?",
      correctAnswer:
        "Velocidade média = Δs / Δt (variação do espaço dividida pela variação do tempo)",
    ...
    },
    {
      ...
      correctAnswer:
        "Nacionalismo, indianismo, sentimentalismo, subjetivismo e valorização da natureza brasileira.",
  ...
  return (
    <div className="ai-assistant-page">
      <div className="page-header">
        <h1>🤖 ENEM AI</h1>
        <p>
          Tire suas dúvidas e obtenha explicações detalhadas sobre questões do
          ENEM
        </p>
      </div>
        ...
        <div className="features-section">
          ...
          <div className="features-grid">
            <div className="feature-card">
              ...
              <p>
                Receba explicações passo a passo de questões complexas do ENEM
              </p>
            </div>
            ...
            <div className="feature-card">
              ...
              <p>
                Obtenha estratégias personalizadas para melhorar seu desempenho
              </p>
            </div>
            ...
            <div className="feature-card">
              ...
              <p>
                Esclareça dúvidas sobre conceitos básicos de todas as matérias
              </p>
            </div>
